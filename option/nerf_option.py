...
class NeRFOption:
    def __init__(self):
        ...
        self.parser.add_argument('--chunk', type=int, default=1024*4)
        ...
        self.parser.add_argument('--save_latest_freq', type=int, default=225 * 2, help='save training model freq')
        self.parser.add_argument('--log_freq', type=int, default=15, help='log loss freq')
        self.parser.add_argument('--num_gpus', type=int, default=4)  # maybe pytorch_lighting use
        self.parser.add_argument('--ckpt', type=str,
        ...
        self.parser.add_argument('--data_root_dir', type=str, default='E:\\dataset\\Cambridge')
        self.parser.add_argument('--scene', type=str, default='StMarysChurch')
        self.parser.add_argument('--use_cache', type=bool, default=True, help='if use cache when loading rays')
        self.parser.add_argument('--if_save_cache', type=bool, default=False,
